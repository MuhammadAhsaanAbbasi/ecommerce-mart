...
async def create_product_items(current_admin: Annotated[Admin, Depends(get_current_active_admin_user)],
    ...
    # product_item = async create_product_item(current_admin, session, product_item_detail, image)
...
async def get_product_items(current_admin: Annotated[Admin, Depends(get_current_active_admin_user)],
                    session: DB_SESSION,
                    product_id: int):
    # product_items = async get_product_item(current_admin, session, product_id)
...
async def delete_product_items(current_admin: Annotated[Admin, Depends(get_current_active_admin_user)],
                    session: DB_SESSION,
                    product_item_id: int):
    #product_item = async delete_product_item(current_admin, session, product_item_id)
...
async def product_sizes(current_admin: Annotated[Admin, Depends(get_current_active_admin_user)],
    ...
    # product_size = async create_product_size(current_admin, session, product_size_detail, product_item_id)
...
async def get_product_sizes(current_admin: Annotated[Admin, Depends(get_current_active_admin_user)],
                        session: DB_SESSION,
                        product_item_id: int):
    # product_sizes = async get_product_size(current_admin, session, product_item_id)
...
async def delete_product_sizes(current_admin: Annotated[Admin, Depends(get_current_active_admin_user)],
                        session: DB_SESSION,
                        product_size_id: int):
    #product_size = async delete_product_size(current_admin, session, product_size_id)
...
async def update_product_sizes(current_admin: Annotated[Admin, Depends(get_current_active_admin_user)],
                        ...
                        product_size_detail: SizeModel,
                        product_size_id: int):
    #product_size = async update_product_size(current_admin, session, product_size_detail, product_size_id)
