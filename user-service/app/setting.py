...
USER_SIGNUP_TOPIC = config.get("USER_SIGNUP_TOPIC")
USER_OTP_TOPIC = config.get("USER_OTP_TOPIC")
USER_SIGNIN_TOPIC = config.get("USER_SIGNIN_TOPIC")
USER_GOOGLE_TOPIC = config.get("USER_GOOGLE_TOPIC")
